...
Farbe1[:,:,0]=np.ones((300,300))*0.1
Farbe1[:,:,1]=np.ones((300,300))*0.1
Farbe1[:,:,2]=np.ones((300,300))*0.8
...
Mischfarbe=0.3*Farbe1+0.7*Farbe2
...
while(True):
   if cv2.waitKey(1) & 0xFF == ord('q'):
        breakimagecolormixdisp.pyimagecolormixdisp.py
